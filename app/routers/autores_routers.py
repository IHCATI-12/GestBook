...
from app.repositories.autores_repo import cadastrar_autor, listar_autores, atualizar_autor, buscar_autor_por_id, deletar_autor
...
def atualizar_dados_autor(autor_id: int, autor: AutorUpdateSchema, db: Session = Depends(get_db), ):
