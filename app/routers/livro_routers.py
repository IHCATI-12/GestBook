...
# Rota para listar livros com filtros opcionais
...
# Rota para deletar livro e seus empréstimos associados substituindo a rota de deletar livro
...
# Rota para listar livros com estoque disponível
